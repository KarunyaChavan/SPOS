...
public class PASS1 {
    ...
    public static void main(String[] args) throws IOException{
        ...
        try{
            BufferedReader br = new BufferedReader(new FileReader("src\\TRY\\sample.txt"));
            BufferedWriter bw = new BufferedWriter(new FileWriter("src\\TRY\\OutputTextTry.txt"));
...
//                                    pos = total_symb;
            ...
            BufferedWriter sw = new BufferedWriter(new FileWriter("src\\TRY\\symTab.txt"));
            sw.write("\nSYMBOL\tADDRESS\n");
            for(int i=0;i<total_symb;i++)
                sw.write(symbol_table[i].name+"\t\t"+symbol_table[i].address+"\n");
            sw.close();

            BufferedWriter lw = new BufferedWriter(new FileWriter("src\\TRY\\litTab.txt"));
            ...
            BufferedWriter pw = new BufferedWriter(new FileWriter("src\\TRY\\poolTab.txt"));
            pw.write("\nPOOL\tTOTAL LITERALS\n");
            for(int i=0;i<pooltab_cnt;i++)
                pw.write(poolTab[i].first+"\t"+poolTab[i].total_literals+"\n");
            pw.close();

            BufferedWriter mw = new BufferedWriter(new FileWriter("src\\TRY\\opTab.txt"));
            mw.write("\nMNEMONIC\tOPCODE\n");
